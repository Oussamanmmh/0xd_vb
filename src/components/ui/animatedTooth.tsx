    ...
    return (
        <div className="relative   sm:w-80 sm:h-80 md:w-[400px] md:h-[400px] flex items-center justify-center my-12 md:m-0">
            ...
            <div className="absolute inset-0 pointer-events-none">
                <div className="w-20 h-20 md:w-full md:h-full rounded-full border-4 border-[#0A6C5E] opacity-20 animate-circle-bounce1" />
            </div>
            <div className="absolute inset-[10%] pointer-events-none">
                <div className="w-20 h-20 md:w-full md:h-full rounded-full border-4 border-[#69F2E6] opacity-20 animate-circle-bounce2" />
            </div>
